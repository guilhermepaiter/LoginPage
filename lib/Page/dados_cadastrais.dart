...
class _CadastroPageState extends State<CadastroPage> {
  ...
  carregarDados() async {
    ...
    nivelSelecionado = await storage.getDadosCadastraisExperiencia();
    ...
    salarioEscolido = await storage.getDadosCadastraisSalario();
  }
